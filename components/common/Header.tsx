  ...
  return (
    <div className="w-full flex items-center justify-between bg-white border-b border-gray-300 px-6 p-3">
      <span className="flex items-center">
        ...
        <span onClick={() => window.location.reload()} className="text-2xl font-bold line-clamp-1 text-transparent bg-clip-text bg-gradient-to-br from-purple-500 to-pink-500 hover:opacity-50 cursor-pointer">Task List</span>
      </span>
