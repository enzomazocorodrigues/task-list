  ...
  return (
    <article className="flex items-center justify-between py-3 px-6 hover:bg-gray-50">
      <div>
        ...
        <h6 className="text-xs font-medium text-transparent bg-clip-text bg-gradient-to-br from-pink-500 to-blue-600">{new Date(task.due_date).toLocaleDateString()}</h6>
      </div>
